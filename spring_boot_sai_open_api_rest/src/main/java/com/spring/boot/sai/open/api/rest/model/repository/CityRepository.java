...
public interface CityRepository extends JpaRepository<City, Long> {
    @Query(value = "SELECT 1 AS id, CIUDADES.ciudad AS name, CIUDADES.codigo AS code, 1 AS state_id, 169 AS country_id FROM CIUDADES where CIUDADES.codigo=:code", nativeQuery = true)
